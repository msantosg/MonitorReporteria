...
update CNF_CONFIGURACION set ESTADO = 1, FECHA_MODIFICACION = GETDATE(), USUARIO_MODIFICACION = 'PROCESO AUTOM�TICO'
where estado = 0 and day(diapublicacion) = day(cast(getdate() as date)) and month(diapublicacion) = month(cast(getdate() as date));
go
...
INSERT INTO AREA_RESPONSABLE VALUES (4, 'DIRECCI�N ADMINISTRATIVA');
INSERT INTO AREA_RESPONSABLE VALUES (5, 'DIRECCI�N FINANCIERA');
INSERT INTO AREA_RESPONSABLE VALUES (6, 'DIRECCI�N DE SISTEMAS');

INSERT INTO AREA_SOLICITANTE VALUES (1, 'SUPERINTENDENCIA DE BANCOS');
INSERT INTO AREA_SOLICITANTE VALUES (2, 'ORGANISMO JUDICIAL');
INSERT INTO AREA_SOLICITANTE VALUES (3, 'MINISTERIO P�BLICO');
INSERT INTO AREA_SOLICITANTE VALUES (4, 'INSTITUTO DE VERIFICACI�N ESPECIAL');